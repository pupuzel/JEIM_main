...
public class JooungoNewboard extends AppCompatActivity implements View.OnClickListener{
  ...
  //사진을 가져오는 메소드
    ...
    public void addboard() { //게시판 등록 버튼 메소드
        ...
        if (group == "0") {
            ...
            mProgress = ProgressDialog.show(JooungoNewboard.this, "서버에 저장하는 중입니다.", "잠시만 기다려 주세요.");
